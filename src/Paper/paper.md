...
There are other cellular automata implementations, Mathematica [@Mathematica], CellPyLib [@Antunes2021], a JOSS Python project from three years ago, and books that cover related territory [@Ceccherini-Silberstein2023]. This is not intended to replace existing cellular automata utilities but to supplement them directly or indirectly by illustrating a new kind of operation on a Wolfram code. 
